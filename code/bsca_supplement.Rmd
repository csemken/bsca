...
```{r, echo=FALSE, fig.height=3, fig.width=7, fig.cap='\\label{fig:mcs_mbsca_inter}MCS data. Multiple outcome BSCA for interactions between different treatments and male.'}
